# Generated by Django 2.1.5 on 2019-03-31 16:44
...
import restaurant_admin.models
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food_img', models.ImageField(null=True, upload_to=restaurant_admin.models.upload_location)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('NO', 'Not Ordered'), ('CH', 'Change Order'), ('OR', 'Ordered'), ('PR', 'Preparing'), ('RE', 'Ready'), ('DE', 'Delivered')], default='NO', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ImageField(upload_to=restaurant_admin.models.upload_location)),
                ('published_date', models.DateField(default=datetime.datetime(2019, 3, 31, 16, 44, 20, 613476, tzinfo=utc))),
            ],
        ),
        migrations.AddField(
